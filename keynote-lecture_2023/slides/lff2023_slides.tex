...
\begin{frame}
  ...
  \begin{itemize}
  \item<2-> \color<2>{blue} Was ist ein {\em Kipppunkt}?
  \item<3-> \color<3>{blue} Welche Beispiele gibt es?
  \item<4-> \color<4>{blue} Was sind die grundsätzlichen Eigenschaften?
  \item<5-> \color<5>{blue} Was ist eine {\em Hysterese}?
  \item<6-> \color<6>{blue} Warum gelten manche Kipppunkte als {\em irreversibel}?
  \item<7-> \color<7>{blue} Welche weiteren Besonderheiten können auftreten?
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item<2-> \color<2>{blue} {\em Gegenkopplung} oder {\em negative} Rückkopplung
    ...
    \item<4-> \color<4>{blue} Beispiele:
      ...
      \item<11-> \color<11>{blue} Sonstige Regelkreise
      \end{itemize}
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \tikz[remember picture, overlay] {
    \node[shift={(0.50cm, 0.50cm)}] at (current page.south west) (t2) {
      \begin{tikzpicture}[remember picture, overlay]
        {\color<2>{blue}
          \draw<2->[thick,->](0.0, 0.5) -- (10.5, 0.5) node[anchor=north west] {\hspace{-2cm}\scriptsize Eingangsgröße};
        }
      \end{tikzpicture}
    }
  }
  \tikz[remember picture, overlay] {
    \node[shift={(0.50cm, 0.50cm)}] at (current page.south west) (t3) {
      {\color<3>{blue}
        \begin{tikzpicture}[remember picture, overlay]
          \draw<3->[thick,->](0.5, 0.0) -- (0.5, 4.0) node[anchor=south west] {\hspace{-0.2cm}\scriptsize Ausgangsgröße};
        \end{tikzpicture}
      }
    }
  }
  ...
  \begin{itemize}
    \item<2-> \color<2>{blue} Eingehende Größe (z.B. Last auf Wippe, \COO-Gehalt der Luft)
    \item<3-> \color<3>{blue} Ausgehende Größe (Neigung der Wippe, Erderwärmung)
    \item<4-> \color<4>{blue} Zustand 1 (Neigung zu einer Seite, jetziges Klima)
    \item<5-> \color<5>{blue} Zustand 2 (Neigung zur anderen Seite, zukünftiges Klima)
    \item<6-> \color<6>{blue} Abrupter Zustandswechsel ({\em Kipppunkt})
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \tikz[remember picture, overlay] {
    \node[shift={(0.50cm, 0.50cm)}] at (current page.south west) (t2) {
      \begin{tikzpicture}[remember picture, overlay]
        ...
        node[anchor=north west] {\hspace{-2cm}\scriptsize Eingangsgröße};
      \end{tikzpicture}
    }
  }
  \tikz[remember picture, overlay] {
    \node[shift={(0.45cm, 0.50cm)}] at (current page.south west) (t3) {
      \begin{tikzpicture}[remember picture, overlay]
        ...
        node[anchor=south west] {\hspace{-0.2cm}\scriptsize Ausgangsgröße};
      \end{tikzpicture}
    }
  }
  \tikz[remember picture, overlay] {
  ...
  Hysterese
  \begin{itemize}
    \item<2-> \color<2>{blue} Zustand 1 (Neigung zu einer Seite, jetziges Klima)
    \item<3-> \color<3>{blue} Zustand 2 (Neigung zur anderen Seite, zukünftiges Klima)
    \item<4-> \color<4>{blue} Wechsel{\em bereich} Zustand 1 {\imply} 2
    \item<5-> \color<5>{blue} Wechsel{\em bereich} Zustand 2 {\imply} 1
