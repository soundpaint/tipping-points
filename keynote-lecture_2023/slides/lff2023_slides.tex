...
{\usebackgroundtemplate
  {\includegraphics[width=\paperwidth,height=\paperheight]
    {../images/title-image\_ultra-light.png}} \frame{\titlepage}}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item<3-> \color<3>{\clr} Betrieb im X-Y-Modus als {\em
      Kennlinienschreiber}
    \item<4-> \color<4>{\clr} Bildwiederholung für stehendes Bild notwendig
    ...
    \item<7-> \color<7>{\clr} {\em Schmit-Trigger} als eigentliches Kippelement
    \item<8-> \color<8>{\clr} Dreieck auf Eingang des Schmit-Triggers legen
    \item<9-> \color<9>{\clr} Ausgang des Schmit-Triggers: Y-Achse
  \end{itemize}
\end{frame}
