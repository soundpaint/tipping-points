...
\begin{frame}[t]
  ...
  \begin{itemize}
    \item<2-> \color<2>{blue} Abschmelzen des sommerlichen arktischen
      Meereises
    \item<3-> \color<3>{blue} Abschmelzen des Grönländischen
      Eisschildes
    \item<4-> \color<4>{blue} Abschmelzen des Westantarktischen
      Eisschildes
    \item<5-> \color<5>{blue} Erlahmen der atlantischen thermohalinen
      Zirkulation
    \item<6-> \color<6>{blue} Veränderung der El Niño-Southern
      Oscillation (ENSO)
    \item<7-> \color<7>{blue} Zusammenbruch des indischen
      Sommermonsuns
    \item<8-> \color<8>{blue} Veränderungen im Westafrikanischen
      Monsunsystem mit Auswirkungen auf Sahara und Sahelzone
    \item<9-> \color<9>{blue} Entwaldung des tropischen Regenwaldes
    \item<10-> \color<10>{blue} Rückgang borealer Wälder
  \end{itemize}
\end{frame}
