...
\date[LFF2020]{Letters for Future, 25. September 2020}
...
\begin{frame}
  ...
  Wie bei Wippe zwei Zustände
  \begin{itemize}
    \item<2-> \color<2>{blue} Zustand 1: Schneedecke vorhanden
    ...
    \item<6-> \color<6>{blue} Zustand 2: Schneedecke geschmolzen
...
\begin{frame}
  ...
  Z.B. zur Hysterese bei der Schneeflächen
  \begin{itemize}
    \item<2-> \color<2>{blue} Wie groß ist die Hysterese?
      \begin{itemize}
